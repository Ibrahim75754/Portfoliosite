<?php 
    ...
    $dc->InsertIntoRegistration($_POST);
                                    ...
                                    <form class="form-horizontal" method="POST" action="">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                ...
                                                <input class="form-control" type="text" name="password" required="" id="password" placeholder="Enter your password">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row text-center mt-2">
                                            <div class="col-12">
                                                ...
                                                <input class="btn btn-md btn-block btn-primary waves-effect waves-light" type="submit" name="insert" value="Sign Up Free">
                                            </div>
                                        </div>
