...
if(isset($_POST['insert'])){
    $dc->InsertIntoCard2($_POST,$_FILES);
    echo "<script>alert('Content insert Successfully.')</script>";
}
if(isset($_GET['id'])){
    $dc->Card2Delete($_GET['id']);
}
                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                        ...
                                        while($data = $get->fetch_assoc()){
                                            ...
                                            <td><a href="sideservice_edit.php?editid=<?php echo $data["id"];?>">Edit</a> | <a onclick="return confirm('Are You Sure?')" href="sideservice.php?id=<?php echo $data["id"];?>">Delete</a></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
