...
<!-- Mirrored from corporx.themetags.com/password-reset.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Jul 2020 07:54:29 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="col-12 col-md-5 col-lg-6 col-xl-4 px-lg-6">
                    <div class="login-signup-wrap px-4 px-lg-5 my-5">
                        ...
                        <form class="login-signup-form">
                            ...
                            <!-- Submit -->
                            <a href="change-password.php" class="btn btn-block secondary-solid-btn">Reset Password</a>
